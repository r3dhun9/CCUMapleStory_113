...
public class MapleLifeFactory {
    ...
    private static final MapleDataProvider data = MapleDataProviderFactory.getDataProvider(ServerProperties.getProperty("server.wzpath") + "/Mob.wz");
    private static final MapleDataProvider stringDataWZ = MapleDataProviderFactory.getDataProvider(ServerProperties.getProperty("server.wzpath") + "/String.wz");
    private static final MapleDataProvider etcDataWZ = MapleDataProviderFactory.getDataProvider(ServerProperties.getProperty("server.wzpath") + "/Etc.wz");
