...
function enter(pi) {
    ...
    if (avail == null) {
        ...
        pi.getClient().getSession().write(MaplePacketCreator.getItemNotice("This door is closed."));
        return false;
    } else {
        pi.getPlayer().changeMap(target, targetPortal);
        pi.getClient().getSession().write(MaplePacketCreator.getItemNotice("RUN TO THE RIGHT FOR YOUR LIFE!!!"));
        return true;
    }
}
