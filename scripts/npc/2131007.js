...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (!cm.haveItem(exchangeItem, 100)) {
            ...
            cm.sendGetNumber("嗯，這是個好主意！ 我可以給你 #i2022457#每100個 #i" + exchangeItem + "##t" + exchangeItem + "# 你想要給我多少 (當前道具: " + cm.getPlayer().itemQuantity(exchangeItem) + ")", java.lang.Math.min(300, cm.getPlayer().itemQuantity(exchangeItem) / 100), 1, java.lang.Math.min(300, cm.getPlayer().itemQuantity(exchangeItem) / 100));
        }
    } else if (status == 2) {
